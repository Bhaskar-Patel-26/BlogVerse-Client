...
const Sidebar = () => {
  return (
    <div className='flex flex-col border-r border-gray-300 min-h-full pt-6'>
      ...
      <NavLink to="/admin/listBlogs" className={({isActive}) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-64 cursor-pointer ${isActive && `bg-primary/10 border-r-4 border-primary`}`}>
